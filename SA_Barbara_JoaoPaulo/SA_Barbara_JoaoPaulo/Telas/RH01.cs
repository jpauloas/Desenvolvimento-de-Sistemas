...
{
    public partial class RH01 : Form
    {
        ...
        {
            Application.Run(new RH11()); // Abre nova janela
        }
        ...
        private void button_Ver_Click(object sender, EventArgs e) //Seleção para ver cadastros
        {
            this.Close();
        ...
        {
            Application.Run(new RH12()); // Abre nova janela
        }
    }
}
